...
INSERT INTO `download` VALUES (1,2,'eerste downloadlink'),(2,2,'tweede downloadlink'),(3,3,'derde downloadlink');
...
INSERT INTO `family` VALUES (1,'Mammals','Give birth',2),(2,'Birds','Fly',2),(3,'Reptiles','lay eggs',2),(4,'Amphibians','Live in wetlands',2),(5,'Insects','Small organisms',2);
...
INSERT INTO `geolocation` VALUES (1,'Ad Dakhiliyah','',''),(2,'Ad Dhahirah','',''),(3,'Al Batinah North','',''),(4,'Al Batinah South','',''),(5,'Al Buraimi','',''),(6,'Al Wusta','',''),(7,'Ash Sharqiyah North','',''),(8,'Ash Sharqiyah South','','');
...
INSERT INTO `habitat` VALUES (1,'Mountains',NULL),(2,'Dessert',NULL),(3,'Reef',NULL),(4,'Wetlands',NULL);
...
INSERT INTO `organism` VALUES (1,'Dhofari goat','Dhofari goat','Dhofari goat',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2015-02-24 00:00:00',NULL),(2,'Jabal Akhdar goat','Jabal Akhdar goat','Jabal Akhdar goat',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2015-02-24 00:00:00',NULL),(3,'Sahrawi goat','Sahrawi goat','Sahrawi goat',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2015-02-24 00:00:00',NULL),(4,'Jabali goat','Jabali goat','Jabali goat',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2015-02-24 00:00:00',NULL);
...
INSERT INTO `season` VALUES (1,'Wet season',''),(2,'Dry season',''),(3,'Winter',''),(4,'Summer','');
...
INSERT INTO `subfamily` VALUES (1,1,'Goat',''),(2,1,'Cow',''),(3,2,'Chicken',''),(4,1,'Oryx',''),(5,1,'Camel','');
...
INSERT INTO `world` VALUES (2,'Plant world','All the organic organisms of oman'),(3,'Animal world','All the animals of oman'),(5,'Marine world','All the water creatures of oman'),(6,'Microbial world','All the microscopic organisms of Oman'),(7,'micro','dit is een test');
...
-- Dump completed on 2015-02-24 19:27:59
