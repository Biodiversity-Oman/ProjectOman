...
<html>
	...
	<ul>
	    ...
	    <li><a href="mailto:developersteam.belgium@gmail.com?Subject=Incident Report" target=_top><strong class=error-message>Version 0.2.2 - For any problems click here to mail</strong></a></li>
