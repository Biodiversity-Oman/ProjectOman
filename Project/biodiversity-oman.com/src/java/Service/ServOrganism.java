...
public class ServOrganism {
                        ...
                        String fooddescription,int[] geolocationid)
    {
        ...
        if (!DaOrganism.checkOrganismExist(scientificname))
        {
            ...
            organismIdNew = DaOrganism.insertOrganism(new BLL.Organism(scientificname, commonname, localname, description,
        ...
        if (organismIdNew < 1)  {return "Service not available. Please contact an administrator if the problem persists.";}
